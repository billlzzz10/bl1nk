 ...
 * @returns {string}
 */
module.exports.gen_sign = function() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.gen_sign();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
 ...
 * @returns {Array<any>}
 */
module.exports.gen_keypair = function() {
    const ret = wasm.gen_keypair();
    return ret;
};
...
module.exports.__wbg_origin_7c5d649acdace3ea = function() { return handleError(function (arg0, arg1) {
...
const path = require('path').join(__dirname, 'gensign_node_bg.wasm');
